...
export class ReviewsService {
  ...
  async getReviewsByTarget(target: TARGET, targetId: string, pageNum: number, pageSize: number): Promise<ReviewDTO[]> {
  ...
  async getReviewSummary(target: TARGET, targetId: string): Promise<ReviewSummary> {
