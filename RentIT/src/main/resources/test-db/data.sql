...
INSERT INTO `products` (`name`, `description`, `day_price`, `week_price`, `month_price`, `deposit`, `city`, `product_value`, `min_lease_period`, `category`, `product_status`, `rented_until`, `user_id`) VALUES ('quo_second', 'Et voluptatibus quisquam qui reiciendis. Nostrum autem necessitatibus nemo a vel maxime aliquam sapiente.', '9642.98', '4.34763', '29821.8', '4', 'Trige', '6', 8, '1', 'AVAILABLE', '1987-01-11', 5);
